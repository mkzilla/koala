...
let AppComponent = class AppComponent {
    constructor(authService, cache) {
        this.authService = authService;
        this.cache = cache;
        this.isCollapsed = false;
        this.user = new _models_user__WEBPACK_IMPORTED_MODULE_3__["User"]();
        this.authService.doGetUserInfo('').then((response) => {
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "default", function() { return StatisticsData; });
...
let CommentTaskComponent = class CommentTaskComponent {
    constructor() { }
    ngOnInit() {
    }
};
...
/* harmony import */ var ng_zorro_antd_notification__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ng-zorro-antd/notification */ "./node_modules/ng-zorro-antd/fesm2015/ng-zorro-antd-notification.js");





let CreateEditOkrComponent = class CreateEditOkrComponent {
    constructor(manager, notification) {
    ...
    showEditObjModal(okr) {
        this.objective = okr;
        this.editObj = true;
    }
    handleConfirmCreateObj() {
        if (this.createObj) {
...
CreateEditOkrComponent.ctorParameters = () => [
...
let DashboardComponent = class DashboardComponent {
    constructor(taskService, notification) {
        this.taskService = taskService;
        this.notification = notification;
...
let EditTaskComponent = class EditTaskComponent {
    constructor(taskService, cache, authService) {
        this.taskService = taskService;
        this.cache = cache;
        this.authService = authService;
...
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm2015/core.js");
/* harmony import */ var ng_zorro_antd_notification__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ng-zorro-antd/notification */ "./node_modules/ng-zorro-antd/fesm2015/ng-zorro-antd-notification.js");
/* harmony import */ var _services_manager_service__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../../../../services/manager.service */ "./src/app/services/manager.service.ts");
...
let GroupsManageComponent = class GroupsManageComponent {
    constructor(manager, notification) {
        this.manager = manager;
        this.notification = notification;
        this.pageNumber = 0;
...
GroupsManageComponent.ctorParameters = () => [
    { type: _services_manager_service__WEBPACK_IMPORTED_MODULE_3__["ManagerService"] },
    { type: ng_zorro_antd_notification__WEBPACK_IMPORTED_MODULE_2__["NzNotificationService"] }
];
tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
...
let ListUsersComponent = class ListUsersComponent {
    constructor(manager, notification, cache) {
        this.manager = manager;
        this.notification = notification;
        this.cache = cache;
...
/* harmony import */ var ng_zorro_antd_notification__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ng-zorro-antd/notification */ "./node_modules/ng-zorro-antd/fesm2015/ng-zorro-antd-notification.js");
/* harmony import */ var _angular_router__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! @angular/router */ "./node_modules/@angular/router/fesm2015/router.js");
...
let ViewGroupComponent = class ViewGroupComponent {
    constructor(manager, route, notification) {
        this.manager = manager;
        this.route = route;
        this.notification = notification;
...
ViewGroupComponent.ctorParameters = () => [
...
let HomepageOkrComponent = class HomepageOkrComponent {
    constructor(taskService, notification, cache) {
        this.taskService = taskService;
        this.notification = notification;
        this.cache = cache;
        this.pageNumber = 0;
...
HomepageOkrComponent.ctorParameters = () => [
...
let HomepageOverviewComponent = class HomepageOverviewComponent {
    ...
    ngOnInit() {
        this.authService.doGetUserInfo(this.username).then((response) => {
            if (response !== undefined) {
                this.user = response;
            }
        });
...
HomepageOverviewComponent.ctorParameters = () => [
    { type: _services_task_service__WEBPACK_IMPORTED_MODULE_2__["TaskService"] },
...
let HomepageTasksComponent = class HomepageTasksComponent {
    constructor(taskService, notification) {
        this.taskService = taskService;
        this.notification = notification;
        this.pageNumber = 0;
...
HomepageTasksComponent.ctorParameters = () => [
    { type: _services_task_service__WEBPACK_IMPORTED_MODULE_2__["TaskService"] },
    { type: ng_zorro_antd_notification__WEBPACK_IMPORTED_MODULE_3__["NzNotificationService"] }
];
tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
...
let HomepageVoteComponent = class HomepageVoteComponent {
    constructor(taskService, notification) {
        this.taskService = taskService;
        this.notification = notification;
        this.pageNumber = 0;
...
HomepageVoteComponent.ctorParameters = () => [
    { type: _services_task_service__WEBPACK_IMPORTED_MODULE_2__["TaskService"] },
    { type: ng_zorro_antd_notification__WEBPACK_IMPORTED_MODULE_3__["NzNotificationService"] }
];
tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
...
let HomepageWatchComponent = class HomepageWatchComponent {
    constructor(taskService, notification) {
        this.taskService = taskService;
        this.notification = notification;
        this.pageNumber = 0;
...
HomepageWatchComponent.ctorParameters = () => [
    { type: _services_task_service__WEBPACK_IMPORTED_MODULE_2__["TaskService"] },
    { type: ng_zorro_antd_notification__WEBPACK_IMPORTED_MODULE_3__["NzNotificationService"] }
];
tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
...
let HomepageWeeklyComponent = class HomepageWeeklyComponent {
    constructor(week) {
        this.week = week;
...
HomepageWeeklyComponent.ctorParameters = () => [
...
let ListRecentTaskComponent = class ListRecentTaskComponent {
    constructor(taskService, cache) {
        this.taskService = taskService;
        this.cache = cache;
        this.user = new _models_user__WEBPACK_IMPORTED_MODULE_4__["User"]();
        this.cache.currentUser.subscribe(u => {
...
ListRecentTaskComponent.ctorParameters = () => [
    { type: _services_task_service__WEBPACK_IMPORTED_MODULE_2__["TaskService"] },
    { type: _services_cache_service__WEBPACK_IMPORTED_MODULE_3__["CacheService"] }
];
...
let ListTaskCommentComponent = class ListTaskCommentComponent {
    constructor(taskService, route) {
        this.taskService = taskService;
        this.route = route;
    }
...
ListTaskCommentComponent.ctorParameters = () => [
    { type: _services_task_service__WEBPACK_IMPORTED_MODULE_2__["TaskService"] },
...
let ListTaskComponent = class ListTaskComponent {
...
ListTaskComponent.ctorParameters = () => [
    { type: _services_task_service__WEBPACK_IMPORTED_MODULE_2__["TaskService"] }
];
...
let ScheduleTaskComponent = class ScheduleTaskComponent {
    constructor(taskService) {
        this.taskService = taskService;
...
ScheduleTaskComponent.ctorParameters = () => [
    { type: _services_task_service__WEBPACK_IMPORTED_MODULE_3__["TaskService"] }
];
tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Output"])()
    ...
    ngOnInit() {
        this.taskService.statistics().then((data) => {
            if (data !== undefined) {
                ...
                this.taskStateChart = echarts__WEBPACK_IMPORTED_MODULE_4__["init"](this.taskStateView.nativeElement, 'macarons');
                this.commentLineChart = echarts__WEBPACK_IMPORTED_MODULE_4__["init"](this.commentLineView.nativeElement, 'macarons');
                this.initTaskStateOptions();
                this.initcommentLineOptions();
            }
        });
    }
    convertStateNumToStr(num) {
        const mp = {};
        mp[0] = '没有进展';
        mp[1] = '即将开始';
        mp[2] = '进行中';
...
let UsersManageComponent = class UsersManageComponent {
    constructor(manager, notification) {
        this.manager = manager;
        this.notification = notification;
        this.pageNumber = 0;
...
UsersManageComponent.ctorParameters = () => [
    { type: _services_manager_service__WEBPACK_IMPORTED_MODULE_2__["ManagerService"] },
    { type: ng_zorro_antd_notification__WEBPACK_IMPORTED_MODULE_3__["NzNotificationService"] }
];
tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
...
let ViewTaskComponent = class ViewTaskComponent {
    constructor(taskService, route, cache) {
        this.taskService = taskService;
        this.route = route;
        this.cache = cache;
...
let WeeklyReportComponent = class WeeklyReportComponent {
    constructor(week, auth) {
        this.week = week;
        this.auth = auth;
        this.reportGroup = [];
        this.groups = [];
...
WeeklyReportComponent.ctorParameters = () => [
...
let RegisterComponent = class RegisterComponent {
    constructor(fb, authService, route, notification, router) {
        this.fb = fb;
        this.authService = authService;
        this.route = route;
        this.notification = notification;
...
let AuthService = class AuthService {
    constructor(http, notification, router) {
        this.http = http;
        this.notification = notification;
        this.router = router;
    ...
    doRegister(data) {
        this.http.post('/api/v1beta/register', data).toPromise().then((response) => {
            this.notification.success('请登录你的邮箱从通知邮件的链接输入密码完成注册', '如果收信箱没有邮件，请检查垃圾箱');
        }).catch((error) => {
            this.notification.error('申请注册失败', error.message);
        });
    }
    doPassword(token, data) {
        return this.http.post('/api/v1beta/password?token=' + token, data).toPromise().then((response) => {
            this.notification.success('请登录你的邮箱从通知邮件的链接输入密码完成注册', '如果收信箱没有邮件，请检查垃圾箱');
        }).catch((error) => {
            this.notification.error('申请注册失败', error.message);
        });
    }
    doBasicLogin(data, next = '/') {
        return this.http.post('/api/v1beta/login', data).toPromise().then((response) => {
...
let ManagerService = class ManagerService {
    ...
    doListUsers(pageNumber = 1, username = '') {
        const params = new _angular_common_http__WEBPACK_IMPORTED_MODULE_3__["HttpParams"]().set('pageNumber', '' + pageNumber).set('like', username);
    ...
    doListInGroups(pageNumber = 1, name = '', enable = true) {
        const params = new _angular_common_http__WEBPACK_IMPORTED_MODULE_3__["HttpParams"]().set('pageNumber', '' + pageNumber).set('name', name).set('enable', '' + enable);
        return this.http.get('/api/v1/manage/groups', { headers: this.headers, params }).toPromise().catch((error) => {
            this.handleError(error, '获取组失败');
        });
    }
    doListGroupUsers(group, pageNumber = 1, name = '') {
        const params = new _angular_common_http__WEBPACK_IMPORTED_MODULE_3__["HttpParams"]().set('pageNumber', '' + pageNumber).set('name', name);
    ...
    doGetGroupOKRs(id, pageNumber) {
        const params = new _angular_common_http__WEBPACK_IMPORTED_MODULE_3__["HttpParams"]().set('pageNumber', '' + pageNumber);
        return this.http.get('/api/v1/manage/group/' + id + '/okr', { headers: this.headers, params }).toPromise().
            catch((error) => {
            this.handleError(error, '获取组信息失败');
        });
    }
    doCreateObjective(objective) {
        if (objective.groupID !== 0) {
            return this.http.post('/api/v1/manage/group/' + objective.groupID + '/okr', objective, { headers: this.headers }).toPromise().catch((error) => {
                this.handleError(error, '创建目标失败');
            });
        }
        if (objective.userID !== 0) {
            return this.http.post('/api/v1/okr/', objective, { headers: this.headers }).toPromise().catch((error) => {
                this.handleError(error, '创建目标失败');
            });
        }
    }
    doEditObjective(objective) {
        if (objective.groupID !== 0) {
            return this.http.put('/api/v1/manage/group/' + objective.groupID + '/okr', objective, { headers: this.headers }).toPromise().catch((error) => {
                this.handleError(error, '编辑目标失败');
            });
        }
        if (objective.userID !== 0) {
            return this.http.put('/api/v1/okr/', objective, { headers: this.headers }).toPromise().catch((error) => {
                this.handleError(error, '编辑目标失败');
            });
        }
    }
...
let TaskService = class TaskService {
    ...
    doUpdate(data) {
        return this.http.post('/api/v1/task/' + data.id, data, { headers: this.headers }).toPromise().then((response) => {
    ...
    doList(type, state = -1, pageNumber = 0, username = '') {
        const params = new _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpParams"]().set('type', type).set('state', '' + state).set('pageNumber', '' + pageNumber).set('username', username);
    ...
    doVote(data) {
        return this.http.post('/api/v1/task/' + data.id + '/vote', {}, { headers: this.headers }).toPromise().then((response) => {
    ...
    doWatch(data) {
        return this.http.post('/api/v1/task/' + data.id + '/watch', {}, { headers: this.headers }).toPromise().then((response) => {
    ...
    doComemnt(data) {
        return this.http.post('/api/v1/task/' + data.task_id + '/comment', data, { headers: this.headers }).toPromise().then((response) => {
    ...
    doListOKR(pageNumber = 0, username = '', type = '') {
        const params = new _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpParams"]().set('pageNumber', '' + pageNumber).set('username', username).set('type', type);
...
let WeeklyService = class WeeklyService {
    constructor(http, notification, router, datepipe) {
        this.http = http;
        this.notification = notification;
        this.router = router;
    ...
    doList(dateRange, username = '') {
        const params = new _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpParams"]().set('from', this.datepipe.transform(dateRange.from, 'yyyy-MM-ddTHH:mm:ss')).set('to', this.datepipe.transform(dateRange.to, 'yyyy-MM-ddTHH:mm:ss'))
